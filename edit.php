...
foreach ($tur as $value){
	...
	<form action="edit_new.php" method="post" >
		Meno: <input type="text" name="a" value="<?php echo $value['meno'] ?>">
		Priezvisko: <input type="text" name="b" value="<?php echo $value['priezvisko'] ?>">
		Narodenie: <input type="text" name="c" value="<?php echo $value['narodenie'] ?>">
		Klub: <input type="text" name="d" value="<?php echo $value['klub'] ?>">
